    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('male', 'Male'), ('female', 'Female'), ('other', 'Other')], default='male', max_length=6, null=True, verbose_name='Gender')),
                ...
                ('logo', models.ImageField(blank=True, null=True, upload_to=apps.users.models.upload_user_image, verbose_name='Logo')),
